...
public class PropertyBundle {
    private static final String PROPERTY_FILE_NAME = "image-recog.properties";
    ...
    static {
        ...
        try {
            ...
            if (in == null) {
                in = PropertyBundle.class.getResourceAsStream("/com/dotcms/rekognition/util/" + PROPERTY_FILE_NAME);
                if (in == null) {
